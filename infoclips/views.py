...
import re
from .forms import UrlForm, SearchForm
...
import openai
openai.api_key = "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"
...
#     # Create a sentiment analysis pipeline using the BERT model
...
#     # print(f"Sentiment score: {result[0]['score']}")
...
#     print(f"The text's polarity score is {polarity}.")
#     print(f"The text's subjectivity score is {subjectivity}.")
